...
def build_executable():
    ...
    cmd = [
        ...
        "--hidden-import=gui.dashboard_page",
        "--hidden-import=gui.chat_page",
        "--hidden-import=gui.actions_page",
        "--hidden-import=gui.diagnostics_page",
        "--hidden-import=gui.settings_page",
